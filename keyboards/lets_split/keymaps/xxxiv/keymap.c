...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ortho_4x12(
    KC_Q,         KC_W,         KC_E,         KC_R,        KC_T,  S(KC_9),    S(KC_0),    KC_Y,    KC_U,          KC_I,             KC_O,           KC_P,
    CTL_T(KC_A),  ALT_T(KC_S),  GUI_T(KC_D),  SFT_T(KC_F), KC_G,  KC_LBRC,    KC_RBRC,    KC_H,    SFT_T(KC_J),   GUI_T(KC_K),      ALT_T(KC_L),    CTL_T(KC_QUOT),
    CTL_T(KC_Z),  ALT_T(KC_X),  GUI_T(KC_C),  KC_V,        KC_B,  KC_MINS,    KC_EQL,     KC_N,    KC_M,          GUI_T(KC_COMM),   ALT_T(KC_DOT),  CTL_T(KC_SLSH),
    KC_LSFT,      KC_LGUI,      KC_ESC,       MO(1),       MO(2), KC_BSPC,    KC_SPC,     KC_RSFT, LT(3, KC_ENT), KC_SCLN,          KC_GRV,         KC_TAB
  ),
